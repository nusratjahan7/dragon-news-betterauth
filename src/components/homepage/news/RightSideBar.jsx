        ...
        <div className=" col-span-3 space-y-4">
            <div className='space-y-3'>
                ...
                <div className='grid gap-2.5'>
                    {/* GitHub */}
                        <button  onClick={handleGithubSignIn} className="btn btn-wide bg-black text-white border-black">
                    ...
                    {/* Google */}
                        ...
                        <button  onClick={handleGoogleSignIn}  className="btn btn-wide bg-white text-black border-[#e5e5e5]">
